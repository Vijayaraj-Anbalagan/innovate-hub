...
const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <nav
      className={` bg-black text-white fixed top-0 left-0 right-0 z-50 transition-transform duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        <div className="flex items-center space-x-4">
          ...
          <div
            ...
            className="text-orange-500 font-bold text-lg cursor-pointer"
          >
            Innovate Hub
          </div>
        </div>
