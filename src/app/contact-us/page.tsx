      ...
      <div className="min-h-screen mt-14 p-12 text-white">
        ...
        <div className="flex flex-col items-center">
          ...
          <form
            ...
            className=" border-white border p-8 rounded-lg shadow-lg w-full max-w-xl"
          >
            <div className="mb-4">
              <label
                htmlFor="name"
            ...
            <button
              type="submit"
              className="bg-orange-500 text-white font-medium text-center rounded-full hover:bg-orange-600 px-10 py-2"
            >
              Send
            </button>
          </form>
