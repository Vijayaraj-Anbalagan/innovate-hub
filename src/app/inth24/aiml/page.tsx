    ...
    <>
      ...
      <div className="min-h-screen p-6 sm:p-12 text-white mt-14">
        <h1 className="text-4xl font-bold text-center text-orange-500 mb-8">
          AI and ML Problem Statements
        </h1>
        <p className="text-lg text-center max-w-4xl mb-8 mx-auto">
          Explore the cutting-edge problem statements in AI and Machine Learning
          provided by top industry leaders. Solve real-world challenges and
            ...
            >
              <div>
                <div className="flex justify-between items-center">
                  ...
                  <p className="text-md text-black mb-2 bg-white rounded-full p-1 px-3 text-center min-w-[90px]">
                    {problem.psid}
                  </p>
                </div>
