      ...
      <div className="min-h-screen p-12 text-white mt-14">
        ...
        <div className="flex flex-col items-center mb-12">
          ...
          <p className="text-lg text-center max-w-4xl mb-8">
            INNOCOM is our platform for students to incubate and express their talents. It fosters
            entrepreneurship and innovation, guiding students towards a successful and independent
            future. Our club aims to elevate the standards of our students, creating achievers and
          ...
          <p className="text-lg text-center max-w-4xl mb-4">
            INNOTHON 24 is a 30-hour hackathon where students are challenged to develop innovative
            solutions to real-world problems. Problem statements of Innothon 24 are Provided by Our
            Industry Partners, giving students the opportunity to tackle genuine challenges faced by
            Industries today.
          </p>
        </div>

        <div className="mb-12">
          <h2 className="text-3xl font-bold text-center mb-6">Evaluation Criteria</h2>
          <div className="flex flex-wrap justify-center items-center gap-4 ">
            {evaluationCriteria.map((criteria, index) => (
              <div
                key={index}
                className="flex flex-col items-center border-2 border-white text-white py-3 px-5 rounded-full hover:bg-orange-600 transition duration-300 ease-in-out cursor-default "
              >
                {criteria.icon}
                <span className="mt-2 text-sm text-center ">{criteria.title}</span>
              </div>
            ))}
          </div>
        ...
        <div className="text-gray-300 p-6 rounded-lg mt-12 items-center justify-center ml-7">
