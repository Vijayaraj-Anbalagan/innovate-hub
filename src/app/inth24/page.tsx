      ...
      <div className="min-h-screen p-12 text-white mt-14 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 justify-center align-middle items-center">
          {problemStatements.map((problem) => (
            <div key={problem.id} className="border border-white p-6 rounded-lg shadow-lg hover:shadow-xl duration-300 cursor-pointer flex flex-col items-center text-center hover:scale-105 transition-all" onClick={() => handleCardClick(`/inth24/${problem.id}`)}>
              {problem.icon}
