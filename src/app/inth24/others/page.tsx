...
import { otherStatements } from '@/lib/others';
  ...
  return (
    <>
      ...
      <div className="min-h-screen p-12 text-white mt-14">
        <h1 className="text-4xl font-bold text-center text-orange-500 mb-8">Other Problem Statements</h1>
        <p className="text-lg text-center max-w-4xl mb-8 mx-auto">
          Discover a variety of problem statements from various fields and industries. These challenges provide a unique opportunity to apply your skills and knowledge to solve diverse real-world problems.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6">
          {otherStatements.map((problem) => (
